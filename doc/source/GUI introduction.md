...
<div columns>
<div item w30>
<img src="./_images/02_1_menubar_file.png"/>
</div>
<div item w70>
...
![02-1_dlg_document](./_images/02_2_dlg_document.png)
...
![04_gif_change_focusing_canvas](./_images/04_gif_change_focusing_canvas.gif)

#### Draggable Cross lines
可顯示一組垂直+水平線，使用滑鼠點擊線可拖拉線至預計標記的點，詳細座標標示於畫布右上角。

![04_gif_draggable_lines](./_images/04_gif_draggable_lines.gif)
...
![04_gif_curve_styling](./_images/04_gif_curve_styling.gif)
...
![04_1_mode_main](./_images/04_1_mode_main.png)
</div>
<div item text_center>
Up and Down

![04_1_mode_upanddown](./_images/04_1_mode_upanddown.png)
</div>
</div>
...
<img src="./_images/04_gif_curve_select_link.gif" w75/>
...
其他編輯也會受到Link/Unlink的模式影響，如編輯曲線的名稱、顏色等。


#### Advance Selector
點選 <img src="./_images/04_2_advance_selector.png" inline style="height: 12px; width: 12px; margin:0px"/>顯示Advance Selector視窗。
<div columns>
<div item w60>
...
例如，若想將Canvas 0畫布的主軸改為Impedance，而Impedance原本為Canvas 1的主軸，故會同時清除Canvas 0畫布與Canvas 1畫布的主軸，並將Canvas 1畫布的資料類別更改為NoType。
